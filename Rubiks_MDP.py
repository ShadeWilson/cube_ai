...
******
Repurposed from A6 for project option 3 by Shade Wilson
shadew@uw.edu
'''
...
GOAL2 = None
def compute_GOAL2():
    raise NotImplementedError("Don't have a second goal state specified")
...
Terminal_state = State(n=N) # The "Terminal" state
